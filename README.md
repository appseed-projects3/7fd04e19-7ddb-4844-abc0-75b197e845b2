...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-17 13:56`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/7fd04e19-7ddb-4844-abc0-75b197e845b2.git
$ cd 7fd04e19-7ddb-4844-abc0-75b197e845b2
```
